...
class Cell:
    ...
    def __add__(self, other):
        return self.quantity + int(other.quantity)

    def __sub__(self, other):
        if self.quantity - int(other.quantity) > 0:
            return self.quantity - int(other.quantity)
        else:
    ...
    def make_order(self, cell, number_row):
        self.cell = cell
        self.number_row = number_row
        row = ''
        for i in range(self.cell.quantity // self.number_row):
            row += f'{"*" * number_row}' + r'\n'
        row += f'{"*" * self.cell.quantity % self.number_row}'
        return row
